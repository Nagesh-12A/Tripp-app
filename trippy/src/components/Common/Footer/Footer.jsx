    ...
    <footer className="pt-5">
      <Container>
        <Row>
          ...
          <a target="_blank" href="mailto:vandananagesh777@gmail.com" className="d-block" >vandananagesh777@gmail.com</a>
          </div>
          <div className="d-flex align-items-top ">
          <i className="bi bi-telephone me-3"></i>
          <a target="_blank" href="tel:7729884738" className="d-block" >7729884738</a>
          </div>
